		...
		return {
			...
			rows: [
				...
				/*{ view:"button", value:"Add view below", inputWidth:200, click:()=>{
					$$("main").addView({ view:"accordionitem", header: "Admin View 3", body:  AdminView3});
				}},
				...
				/* Tabview */
				// { view:"button", value:"Add view below", click:()=>{
				// 	$$("main").addView({ header: "Admin View 3", body:AdminView3});
				// }},
				...
				/*{ view:"button", value:"Add view below", inputWidth:200, click:()=>{
					$$("tabs").addOption("Admin View 3");
					$$("main").addView({ id:"Admin View 3", $subview:  AdminView3});
				}},
